<?php $__env->startSection("content"); ?>
    ...
    <div class="col-sm-8 blog-main">
        ...
        <div class="user-info">
            <img src="<?php echo e($user->gravater(140)); ?>" alt="" class="img-rounded" style="border-radius:500px; height: 40px"> <?php echo e($user->name); ?>


            <div class="user-info-right">关注：<?php echo e($user->stars_count); ?>｜粉丝：<?php echo e($user->fans_count); ?>｜文章：<?php echo e($user->posts_count); ?></div>
                ...
                <div class="tab-pane active" id="tab_1">
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="blog-post">
                            ...
                            <p class="blog-post-meta"><a href="/user/<?php echo e($post->user_id); ?>"><?php echo e($post->user->name); ?></a> <?php echo e($post->created_at->diffForHumans()); ?></p>
